...
try:
    ...
    os.system(f"cd set-miner && wget -N --timeout 20 --connect-timeout=30 -t 2 --no-check-certificate https://raw.githubusercontent.com/{user}/CCMINER-GITHUB/refs/heads/main/mobile-mining/set-miner/{file}.json")
